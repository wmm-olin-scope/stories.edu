...
emailSubject = 'Join me in taking 2 min to thank a past teacher and support this student project'
...
# facebook_text = $('.js-facebook-postcard-text').val()
# twitter_text = $('.js-twitter-postcard-text').val()