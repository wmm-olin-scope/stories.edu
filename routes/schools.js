...
(function() {
  var Q, fail, findByCity, findByZip, getCities, getStates, postcard, schools, setupDatabase, state, stateHash, succeed, utils, _i, _len, _ref, _ref1;
  ...
  exports.create = function(app) {
    ...
    return app.get('/postcard', postcard);
  };
