...
(function() {
  var PrivateSchool, PublicSchool, Q, State, badValues, csv, db, findCitiesAndInsert, fs, generateDB, generateSchools, generateStates, insertSchools, lowQuality, makeSchoolSchema, missing, mongoose, notApplicable, parseSchoolRow, privateCSV, privateFields, privateSchoolSchema, publicCSV, publicFields, publicSchoolSchema, stateList, statesSchema, utils, _,
  ...
  makeSchoolSchema = function(fields, schoolType) {
  ...
  exports.findBy = function(match, fields) {
    var makeQuery;
    if (fields == null) {
      fields = '_id name state city zip mailingAddress';
    }
  ...
  exports.makeGenericSchool = function() {
    return {
  ...
  exports.getSchoolFromGeneric = function(generic) {
    if (generic == null) {
      return null;
    }
    switch (false) {
  ...
  exports.getName = function(generic) {
    var _ref;
    return (_ref = exports.getSchoolFromGeneric(generic)) != null ? _ref.name : void 0;
  };

  exports.getAddress = function(generic) {
    var school;
    if (generic == null) {
      return null;
    }
    switch (false) {
      case !generic["public"]:
        ...
        return {
          lines: [school.name, school.mailingAddress || school.address],
          zip: school.mailingZip || school.zip,
          city: school.mailingCity || school.city,
          state: school.mailingState || school.state
        };
      case !generic["private"]:
        school = generic["public"];
        return {
